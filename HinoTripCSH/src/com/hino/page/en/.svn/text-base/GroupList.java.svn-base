...
public class GroupList extends BasePage {
    ...
    public void onInit() {
            ...
            Column column = new Column("gname", "Group Name");
    		...
    		column = new Column("depart_date", "Depart Date");
    		column.setDecorator(new Decorator(){
    			@Override
    			public String render(Object object, Context context) {
    				Group g = (Group)object;
    		...
    		column = new Column("price", "Price");
    		booking_table.addColumn(column);
    	
    		column = new Column("vip_price", "VIP Price");
    		booking_table.addColumn(column);
    		
    		column = new Column("depart_city", "Pick up cities");
    		column.setDecorator(new Decorator(){
    			@Override
    			public String render(Object object, Context context) {
    				Group g = ((Group) object);
    		...
    		column = new Column("external_indicator_en", "Info");
    		column.setSortable(false);
    		booking_table.addColumn(column);
    		
    		//ticketLink.setParameter("type", value)
    		column = new Column("action", "Boking");
    		column.setDecorator(new Decorator(){
    			@Override
    			public String render(Object object, Context context) {
    				Group g = ((Group) object);
    				...
    				if(g.getExternalBookable()) {
    					return "<a href=\"./booking.htm?gid="+String.valueOf(g.getId())+"\">Booking</a>";
    				} else {
    					return "Full";
    				}
