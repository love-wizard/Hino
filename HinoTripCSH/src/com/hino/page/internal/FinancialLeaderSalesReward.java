...
public class FinancialLeaderSalesReward extends BasePage {
	@Bindable
	...
	private Submit calculate = new Submit("calculate", "生成销售代表业绩");
        		...
        		if(s!=null&&e!=null)
        		{
        			...
        			table.setDataProvider(new DataProvider<SalesRewardDto>() {
        				public List<SalesRewardDto> getData() {
        					return getFinancialService().sales_summary_forLeader(curStaff.getId(), c1, c2);
        				}
