...
function inputText(el) { //extent Text inputs
	...
	el.left.src = imagesPath + "blank.png";
	el.left.className = "NFTextLeft";
	el.right = document.createElement('img');
	el.right.src = imagesPath + "blank.png";
...
function inputCheck(el) { //extend Checkboxes
	...
	el.dummy.src = imagesPath + "blank.png";
...
function inputFile(el) { //extend File inputs
	...
	el.button.src = imagesPath + "blank.png";
...
function textarea(el) { //extend Textareas
	...
	el.topLeft.src = imagesPath + "blank.png";
	el.topLeft.className = "NFTextareaTopLeft";
	el.topRight = document.createElement('div');
	el.topRight.className = "NFTextareaTop";
	el.bottomLeft = document.createElement('img');
	el.bottomLeft.src = imagesPath + "blank.png";
...
//Modified by Lilei Zhai to aviod loading delay of IE
/*
