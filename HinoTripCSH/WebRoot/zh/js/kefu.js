...
function kf_createList() {
	...
	jQuery.ajax({
		...
		success: function(data, textStatus) {
			...
			jQuery.each(data.kefus, function(idx, kefu) {
				kfItem = 			"<li>";
				kfItem = kfItem + 	"	<a class='icoTc' href='http://wpa.qq.com/msgrd?V=1&Uin=" + kefu['qq'] + "'>" + kefu['sn'] + "</a>";
				kfItem = kfItem + 	"</li>";
				
				kfList = kfList + kfItem;
			});

			$("#divFloatToolsView .cn .ke_list").replaceWith(kfList);
		}
	});
}